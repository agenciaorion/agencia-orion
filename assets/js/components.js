...
function renderLeadModal() {
  ...
  const CHIP_SERVICES = ['Estratégia & Branding','Tráfego Pago','Social Media','Design Gráfico','AudioVisual','Drone','Cobertura de Eventos','Influencers','Sites & Apps','Produção de Áudio','LED Outdoor','Book Fotográfico','TI & Sistemas','Não sei ainda'];
